<div class="flex justify-center mx-auto my-6 py-12">
  
    <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg rounded-lg pin-r pin-y md:w-4/5 lg:w-4/5">
      <div class="flex-1">
              ...
              <p class="mb-4 italic">If you have a coupon code, please enter it in the box below</p>
                <div class="grid grid-cols-4 gap-4">
                  @foreach ($coupons as $coupon)
                    <div class="bg-gray-800 text-center text-sm text-white cursor-pointer hover:shadow-lg shadow-md font-bold p-3 rounded-lg">
                      ${{$coupon->value}}
                    </div>
                  @endforeach
                </div>
            ...
            <div class="p-4">
              ...
              <div class="grid grid-cols-3 grid-rows-3 gap-4">
                @foreach ($payments as $payment)
                  <div class="bg-purple-600 text-center text-sm text-white cursor-pointer hover:shadow-lg shadow-md font-bold p-3 rounded-lg">
                    {{$payment->title}}
                  </div>
                @endforeach
              </div>

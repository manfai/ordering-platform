    ...
    <footer class="flex justify-center px-4 text-gray-800 bg-gray-100 dark:text-white dark:bg-gray-800">
      <div class="container pt-12 pb-6">
          ...
          <div class="flex justify-center mt-6">
              <div class="bg-white border rounded-md focus-within:ring focus-within:border-gray-500">
          ...
          <div class="flex flex-col items-center justify-between mt-6 md:flex-row">
              <div>
                  <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">EC Mart</a>
              </div>
